...
/* Stat math*/
$user_development = $user_recent[0]["User_all"] / 24;
if($user_development > $user_recent[0]["User_recent"]){
echo "positive, $user_development";
}elseif($user_development < $user_recent[0]["User_recent"]){
echo "negative, $user_development";
}
